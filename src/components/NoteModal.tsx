          ...
          <div className="flex-1 overflow-y-auto pt-8 pb-20 scroll-smooth">
            <div className="px-10 space-y-6">
              <Input 
                ...
                className={cn(
                  "border-none shadow-none focus-visible:ring-0 focus-visible:ring-offset-0 outline-none text-2xl sm:text-3xl md:text-4xl font-black px-0 bg-transparent h-auto placeholder:opacity-20 transition-all",
